  ...
  <section class="mcon-otherdemos">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div data-thumb="../img/adg3.jpg" data-type="audio"
             class="aptest-with-play skin-wave-mode-small audioplayer-tobe skin-wave button-aspect-noir     "
             data-source="http://devsite/wpfactory/dzsap/wp-content/uploads/sites/4/2017/10/Jama.m4a"
             data-playfrom="last" data-fakeplayer=".dzsap_footer"
             data-pcm="<?php echo get_pcm('', 'http://devsite/wpfactory/dzsap/wp-content/uploads/sites/4/2017/10/Jama.m4a'); ?>">
...
//            $('.the-media').html('alceva');
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <p>It takes just 3 minutes to install, activate and setup your first pricing table like the one above. It's
            all possible because of a smart WYSIWYG shortcode generator and premade examples so you can customize from
            there to your needs.</p>
          <p>
    ...
    <div class="container">
      <div class="row" style="margin-bottom: 0;">
        <div class="col-md-6">
          ...
          <p>Mobile ready! Retina ready! Tested on iOS and Android 4.0+. Responsive from mobile to HD due to CSS 3 Media
            Queries. Retina ready due to use of font icons and no images. Scales to any dimension!</p>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          ...
          <h4>Easy Install</h4>
          <p style="text-align: center">Install WordPress Pricing Tables in just a couple of minutes. <a
              href="http://digitalzoomstudio.net/docs/wppricingtables/" target="_blank">Docs</a> are also there.</p>
        </div>
        <div class="col-md-3">
          <div class="bigfeature"><i class="icon-desktop"></i></div>
          <h4>Responsive</h4>
          <p style="text-align: center">From mobile to HD, pricing tables are ultra responsive. Also has retina
            graphics.</p>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
          ...
          <h4>SEO Friendly</h4>
          <p style="text-align: center">Built with SEO in mind, Pricing Tables parses html content into working
            magic.</p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6" style="text-align: right">
          <iframe
            src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fdigitalzoomstudio&amp;width=150&amp;height=21&amp;colorscheme=light&amp;layout=button_count&amp;action=like&amp;show_faces=true&amp;send=false&amp;appId=569360426428348"
  ...
  <section class="dzsap-sticktobottom  dzsap-sticktobottom-for-skin-wave-small">
    ...
    <style>.audioplayer.skin-wave#dzsap_footer .ap-controls .con-playpause .playbtn, .audioplayer.skin-wave#dzsap_footer .btn-embed-code, .audioplayer.skin-wave#dzsap_footer .ap-controls .con-playpause .pausebtn {
        background-color: #111111;
      }  </style>


    <div
      class="audioplayer-tobe dzsap_footer theme-dark button-aspect-noir button-aspect-noir--stroked skinvariation-wave-righter"
      style="" id="ap_footer" data-type="fake" data-source="fake" data-thumb="../img/adg3.jpg">
            <span class="meta-artist"><span class="the-artist">Adrien Gardiner</span><span class="the-name"><a
                  href="http://codecanyon.net/item/zoomsounds-wordpress-audio-player/6181433?ref=ZoomIt"
                  target="_blank">Eco2 the Boost</a></span>
                </span>
    </div>
