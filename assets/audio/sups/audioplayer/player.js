...
//                    o.disable_scrub = 'on';
        ...
        if (cthis.find('.the-comments').length > 0 && cthis.find('.the-comments').eq(0).children().length > 0) {
          commentsArray = cthis.find('.the-comments').eq(0).children();
        }
...
//                    type='audio';
        ...
        if ((can_play_mp3() == false && cthis.attr('data-sourceogg') == undefined) || is_ie8()) {
          is_flashplayer = true;
        }
...
//                    img.src= cthis.attr('data-source');
      ...
      function setup_controls_commentsHolder() {
        ...
        for (i = 0; i < commentsArray.length; i++) {
          if (_commentsHolder && commentsArray[i] != null) {
            _commentsHolder.append(commentsArray[i]);
